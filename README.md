...
- [vite-plugin-nightwatch](https://github.com/nightwatchjs/vite-plugin-nightwatch) - Component testing plugin that Nightwatch.js. Supports Vue and React components.
