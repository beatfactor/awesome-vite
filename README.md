...
- [vite-plugin-nightwatch](https://github.com/nightwatchjs/vite-plugin-nightwatch) - Component testing plugin that integrates Vite with [Nightwatch.js](https://github.com/nightwatchjs/nightwatch). Supports Vue and React components.
<hr>
